...
\item[$\ast$] Toute figure doit avoir une légende et être citée dans le document.
\item[$\ast$] Si des ressources extérieures ont été mobilisées, elles doivent être de citées en fin
de document de façon à pouvoir y accéder.
Ces citations ne sont pas prises en compte dans le nombre de pages.
\end{itemize}
